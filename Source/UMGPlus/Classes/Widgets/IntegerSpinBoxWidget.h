...
#include "IntegerSpinBoxWidget.generated.h"

UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "Spin Box (Int32)"))
class UMGPLUS_API UUPIntegerSpinBox 
    : public UWidget
{
	GENERATED_BODY()
...
protected:
    TSharedPtr<SSpinBox<int32>> SlateWidget;
